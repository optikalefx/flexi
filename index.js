...
module.exports = {
  ...
  _checkDependencyCompatibility(project) {
    ...
    if (flexiDefaultStylesVersion && SEMVER.lt(flexiDefaultStylesVersion, '2.0.0-rc.1')) {
      this._warnUser('flexi-default-styles < v2.0.0-rc.1;'
                     + ' consider upgrading to at least v2.0.0-rc.1');
    }
    if (flexiDslVersion && SEMVER.lt(flexiDslVersion, '2.0.0-rc.1')) {
      this._warnUser('flexi-dsl < v2.0.0-rc.1; consider upgrading to at least v2.0.0-rc.1');
    }
    if (flexiLayoutsVersion && SEMVER.lt(flexiLayoutsVersion, '2.0.0-rc.1')) {
      this._warnUser('flexi-layouts < v2.0.0-rc.1; consider upgrading to at least v2.0.0-rc.1');
    }
  },
